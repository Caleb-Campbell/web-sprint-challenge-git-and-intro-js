...
function getArtistByIndex(array, desInd) {
  return `the artist at index ${desInd} is ${array[desInd].name}`
}
...
function removeArtist(array, remover) {
